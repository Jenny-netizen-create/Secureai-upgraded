/* SecureAI - Shared Script
   Theme toggle, hamburger menu, search dropdown, scroll fade-in, animated counters */

(function () {
  /* THEME TOGGLE */
  const root = document.documentElement;
  const savedTheme = localStorage.getItem('secureai-theme') || 'dark';
  ...
  function setupThemeToggle() {
    ...
    btn.addEventListener('click', () => {
      ...
      localStorage.setItem('secureai-theme', next);
  ...
  const SITE_INDEX = [
    ...
    { title: 'Cybersecurity Quiz', url: 'quiz.html', tags: ['quiz','test','game','learn','score'] },
    { title: 'News & Articles', url: 'news.html', tags: ['news','articles','blog','updates'] },
